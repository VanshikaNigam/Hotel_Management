import javax.swing.*;
public class Service1 extends JDialog
{
	...
	Service1()
	{
		...
		setSize(400,400);
		setModal(true);
		JLabel j=new JLabel("Services in our DELUXE rooms are:");
		...
		JLabel je=new JLabel("5.Spa Treatment");
		JLabel jf=new JLabel("6.Evening Snacks");
		JLabel jg=new JLabel("7.Dinner");
		...
		je.setBounds(20,170,220,30);
		jf.setBounds(20,190,240,30);
		jg.setBounds(20,210,260,30);
		add(j);
		add(ja);
		add(jb);
		add(jc);
