import javax.swing.*;
public class Rate1 extends JDialog
{
	Rate1()
	{
		...
		setSize(400,380);
		setModal(true);
		JLabel j=new JLabel("Rate of DELUXE room is:");
		JLabel ja=new JLabel("Fooding : 1000 (1 day and 1 night)");
		JLabel jb=new JLabel("Lodging : 1000 (1 day and 1 night)");
		JLabel jc=new JLabel("Services : 3000 (1 day and 1 night)");
		JLabel jd=new JLabel("TOTAL COST : Rs 5000 (1 day and 1 night)");
